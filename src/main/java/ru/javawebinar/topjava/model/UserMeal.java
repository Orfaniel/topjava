...
@NamedQueries({
        ...
        @NamedQuery(name = UserMeal.GET_BETWEEN, query = "SELECT um FROM UserMeal " +
                "um WHERE um.user.id=:userID AND um.dateTime >=:after AND um.dateTime <=:before ORDER BY um.dateTime DESC"),
})
@Entity
@Table(name = "meals")
